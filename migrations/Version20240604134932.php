 ...
 */
final class Version20240604134932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE election-select (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, voices INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE election_code ADD CONSTRAINT FK_EB5A47BEA708DAFF FOREIGN KEY (election_id) REFERENCES election-select (id)');
        ...
        $this->addSql('ALTER TABLE election_result_election ADD CONSTRAINT FK_781D91FEA708DAFF FOREIGN KEY (election_id) REFERENCES election-select (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE person ADD CONSTRAINT FK_34DCD176A708DAFF FOREIGN KEY (election_id) REFERENCES election-select (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE election-select');
